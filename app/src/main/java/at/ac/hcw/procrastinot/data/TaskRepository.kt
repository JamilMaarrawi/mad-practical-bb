...
interface TaskRepository {
    ...
    suspend fun createTask(title: String, description: String, priority: TaskPriority): String

    suspend fun updateTask(taskId: String, title: String, description: String, priority: TaskPriority)
